...
struct poisson_power_estimation_fixture : prm_testset_fixture {
    ...
    virtual ~poisson_power_estimation_fixture() { /*BOOST_TEST_MESSAGE( "teardown fixture -- power_estimation_fixture" );*/ }
...
struct bernoulli_power_estimation_fixture : prm_testset_fixture {
    ...
    virtual ~bernoulli_power_estimation_fixture() { /*BOOST_TEST_MESSAGE( "teardown fixture -- power_estimation_fixture" );*/ }

...
void Parameters::copy(const Parameters &rhs) {
    ...
    _disallow_multi_parent_nodes = rhs._disallow_multi_parent_nodes;
    _disallow_multiple_roots = rhs._disallow_multiple_roots;
}
...
void Parameters::setAsDefaulted() {
    ...
    _disallow_multi_parent_nodes = true;
    _disallow_multiple_roots = true;

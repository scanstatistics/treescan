...
const char * AbtractParameterFileAccess::GetParameterComment(Parameters::ParameterType e) const {
    try {
        switch (e) {
            ...
            case Parameters::DISALLOW_MULTI_PARENT_NODES: return "disallow multi-parent nodes - (y/n)";
            case Parameters::DISALLOW_MULTIPLE_ROOTS : return "disallow multiple root nodes - (y/n)";
...
std::string & AbtractParameterFileAccess::GetParameterString(Parameters::ParameterType e, std::string& s) const {
    ...
    try {
        switch (e) {
            ...
            case Parameters::DISALLOW_MULTI_PARENT_NODES: return AsString(s, _parameters.getDisallowMultiParentNodes());
            case Parameters::DISALLOW_MULTIPLE_ROOTS  : return AsString(s, _parameters.getDisallowMultipleRoots());
...
void AbtractParameterFileAccess::SetParameter(Parameters::ParameterType e, const std::string& value, BasePrint& PrintDirection) {
    ...
    try {
        switch (e) {
            ...
            case Parameters::DISALLOW_MULTI_PARENT_NODES: _parameters.setDisallowMultiParentNodes(ReadBoolean(value, e)); break;
            case Parameters::DISALLOW_MULTIPLE_ROOTS  : _parameters.setDisallowMultipleRoots(ReadBoolean(value, e)); break;

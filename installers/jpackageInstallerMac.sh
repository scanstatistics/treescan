...
# https://pwvault.imsweb.com/SecretServer/app/#/secret/25934/general -- update
if [[ $# -gt 0 ]]; then
  PASSWORD=$1
else
...
scp -r $BUNDLEDIR/bin/TreeScan-${APPVERSION}.dmg $BUNDLEDIR/TreeScan.zip treescan@gen-btp-01.imsweb.com:${INSTALLER_DIR}
